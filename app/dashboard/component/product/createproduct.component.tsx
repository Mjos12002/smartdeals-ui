            ...
            <div>
                <form action={addProduct}>
                    <ul className="flex gap-4 flex-col m-0">
                        ...
                        <li>
                            <input type="text" placeholder="Price" name="price" className="rounded-sm border-gray-300 border border-shadow w-[30%] p-2" />
                        </li>
                        <li>
                            <input type="text" placeholder="Discount %" name="discount" className="rounded-sm border-gray-300 border border-shadow w-[30%] p-2" />
                        </li>
                        <li>
                            <input type="text" placeholder="Discounted price" name="discounted_price" className="rounded-sm border-gray-300 border border-shadow w-[30%] p-2" />
                        </li>
                        <li>
                            <input type="date" placeholder="Discount start date" name="discount_start_date" className="rounded-sm border-gray-300 border border-shadow w-[30%] p-2" />
                        </li>
                        <li>
                            <input type="date" placeholder="Discount end date" name="discount_end_date" className="rounded-sm border-gray-300 border border-shadow w-[30%] p-2" />
                        </li>
                        <li>
                            <select name="status" className="rounded-sm border-gray-300 border border-shadow w-[30%] p-2">
                                <option id="active">Active</option>
                                <option id="inactive">Inactive</option>
                            </select>
                        </li>
                        <li>
                            <select name="product_categories_id" className="rounded-sm border-gray-300 border border-shadow w-[30%] p-2">
                                {
                        ...
                        <li>
                            <input type="file" placeholder="Logo" name="logo" className="rounded-sm border-gray-300 border border-shadow w-[30%] p-2" />
                        </li>
                        <li>
